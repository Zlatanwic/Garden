...
<template>
  <div ref="rootRef" class="electric-border-container" :class="className" :style="style">
    <svg
      ref="svgRef"
      class="electric-filter-svg"
    ...
    <div class="electric-content" :style="inheritRadius">
      <slot />
    </div>

    <div class="electric-layer" :style="inheritRadius">
      <div ref="strokeRef" class="electric-stroke" :style="strokeStyle" />
      <div class="electric-glow" :style="glow1Style" />
      <div class="electric-glow" :style="glow2Style" />
      <div class="electric-bg-glow" :style="bgGlowStyle" />
    </div>
  </div>
</template>
